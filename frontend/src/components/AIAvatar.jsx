...
const AIAvatar = ({ placement_probability, result }) => {
  ...
  useEffect(() => {
    if (isOpen && messages.length === 0) {
      const initialMsgs = [
        { role: 'ai', text: `Hello! I'm your HRCV AI Recruiter. I've analyzed your profile and I'm ready to help you prepare for your target company.` },
  ...
  const handleSendMessage = (e, overrideText = null) => {
    ...
    setTimeout(() => {
      ...
      else if (input.includes('hello') || input.includes('hi') || input.includes('hrcv')) {
        responseText = "Hello! I'm your HRCV assistant. I can help you decode your CV performance, explain your placement probability, or guide you through your skill roadmap. What's on your mind?";
      } 
      else {
        ...
        <div className="fixed bottom-6 right-6 w-80 md:w-96 glass-card p-0 overflow-hidden z-50 shadow-2xl border border-white/20 animate-fade-in-up">
          ...
          <form onSubmit={handleSendMessage} className="p-3 bg-slate-50 border-t border-slate-200 flex gap-2">
            ...
            <input 
              ...
              placeholder={isListening ? "Listening..." : "Ask HRCV about your CV..."}
