        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '48px' }}>
          ...
          <div>
            <div style={{ fontSize: '22px', fontWeight: 800, color: '#fff', letterSpacing: '-0.5px' }}>
              HR<span style={{ background: 'linear-gradient(135deg,#a78bfa,#818cf8,#38bdf8)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>CV</span>
            </div>
            ...
            {authStage === 'waking' && (
              <div style={{
                ...
                <p style={{ color: '#fcd34d', fontSize: '12px', margin: 0, lineHeight: 1.5 }}>
                  HRCV server is waking up. This may take up to a minute on free hosting.
                </p>
              </div>
            )}
            <button
            ...
            >
              {isLoading ? (
                <>
                  ...
                  {authStage === 'connecting' && 'Connecting to HRCV...'}
